...
<div id="extensions" class="gt-tab-pane">
    <p class="about-description">
        ...
        <br>
		<?php esc_html_e( 'Save over 80% with our extensions bundles.', 'meta-box' ); ?> <a target="_blank"
                                                                                            href="https://metabox.io/pricing/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'View Bundles', 'meta-box' ); ?>
            &rarr;</a>
    </p>
        ...
        <div class="extension">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/custom-post-type/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Free Download', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/meta-box-builder/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/meta-box-group/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/mb-settings-page/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/meta-box-conditional-logic/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/mb-user-profile/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/mb-frontend-submission/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/mb-custom-table/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Learn More', 'meta-box' ); ?></a>
            </div>
        </div>
        <div class="extension">
            <div class="extension-inner">
            ...
            <div class="extension-action">
                <a class="button" target="_blank"
                   href="https://metabox.io/plugins/mb-relationships/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'Free Download', 'meta-box' ); ?></a>
            </div>
        </div>
    </div>
    <a href="https://metabox.io/plugins/?utm_source=WordPress&utm_medium=link&utm_campaign=plugin"><?php esc_html_e( 'View all extensions', 'meta-box' ); ?>
        &rarr;</a>
</div>
